import{_ as Y,a as z,b as x,c as S,d as J,e as K,f as $}from"./index-2K3MavtT.js";/**
 * @license
 ...
 */if(ee()&&self.firebase!==void 0){A.warn(`
  ...
  `);var B=self.firebase.SDK_VERSION;B&&B.indexOf("LITE")>=0&&A.warn(`
    ...
    `)}var He=M.initializeApp;M.initializeApp=function(){for(var t=[],e=0;e<arguments.length;e++)t[e]=arguments[e];return Q()&&A.warn(`
      ...
      `),He.apply(void 0,t)};var Me=M;je(Me);export{j as C,re as F,u as L,Be as a,Ue as b,Ve as c,We as d,ke as e,Me as f,F as g,Ge as h,$e as i,ve as j};
//# sourceMappingURL=index.esm-J35DBGFx.js.map
